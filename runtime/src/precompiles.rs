...
use pallet_evm_precompile_parachain_staking::ParachainStakingPrecompileSet;
...
where
    ...
    ParachainStakingPrecompileSet<R>: PrecompileSet,
    R: pallet_evm::Config
        ...
        + AddressToAssetId<<R as pallet_assets::Config>::AssetId>,
{
    fn execute(&self, handle: &mut impl PrecompileHandle) -> Option<PrecompileResult> {
        ...
        match address {
            ...
            a if a == hash(2048) => ParachainStakingPrecompileSet::<R>::new().execute(handle),
