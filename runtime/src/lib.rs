...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Treasury: pallet_treasury::<Instance1>::{Pallet, Call, Storage, Config, Event<T>} = 14,
		CommunityTreasury: pallet_treasury::<Instance2>::{Pallet, Call, Storage, Config, Event<T>} = 15,
