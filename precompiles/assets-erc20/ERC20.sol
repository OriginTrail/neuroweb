...
interface IERC20Plus is IERC20 {
     ...
     * @param spender The address which will spend the funds.
     * @param addedValue The amount of tokens to be added to allowance.
     */
    function increaseAllownce(address spender, uint256 addedValue)
        external
        returns (bool);
     ...
     * @param spender The address which will spend the funds.
     * @param subtractedValue The amount of tokens to be subtracted from allowance.
     */
    function decreaseAllownce(address spender, uint256 subtractedValue)
        external
        returns (bool);
}
