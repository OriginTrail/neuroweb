...
/// Weights for module_evm_accounts using the OTP node and recommended hardware.
pub struct OTPWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> WeightInfo for OTPWeight<T> {
	fn claim_account() -> Weight {
